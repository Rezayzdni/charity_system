...
export default class CharityProfile extends React.Component {
    ...
    componentDidMount() {
        ...
        // Fetch user and charity fields
        axios.get('http://localhost:8000/api/user-charity-fields/', {
            headers: {
        ...
        .then((response) => {
            ...
            const charity = response.data.charity; // Assuming the first charity is relevant
            // console.log('user and charity fields', user, charity);
            this.setState({
                fields: {
                    ...
                    regnumber: charity.reg_number
                }
            });
            console.log('fields', this.state.fields);
        })
        .catch((error) => {
            console.error('Error fetching user and charity fields:', error);
        });
    ...
    componentDidUpdate(prevProps, prevState) {
        const getToken = window.localStorage.getItem('token');
        // Check if the charityname has changed
        if (prevState.fields.charityname !== this.state.fields.charityname) {
            console.log("Updated charity name:", this.state.fields.charityname);

            let name = this.state.fields.charityname;
        console.log("charity name is : ",this.state.fields.charityname);
    ...
    handleSubmit(event) {
        ...
        axios.put('http://localhost:8000/api/user-charity-fields/', data, {
            headers: {
                'Authorization': `Token ${token}`,
                            ...
                            <Form.Row>
                                <Col>
                                    ...
                                    <Form.Control name='firstname'
                                        ...
                                        value={this.state.fields.firstname || ''} // Ensure empty string if null
                                ...
                                <Col>
                                    ...
                                    <Form.Control name='lastname'
                                        ...
                                        value={this.state.fields.lastname || ''} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)} />
                                </Col>
                            </Form.Row>
                            <Form.Row>
                                <Col>
                                    ...
                                    <Form.Control as='select' name='gender'
                                        value={this.state.fields.gender || 'MF'} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)}>
                                ...
                                <Col>
                                    ...
                                    <Form.Control type='number' name='age'
                                        ...
                                        value={this.state.fields.age || ''} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)}
                                    />
                                </Col>
                            </Form.Row>
                            <Form.Row>
                                <Col>
                                    ...
                                    <Form.Control name='email'
                                        ...
                                        value={this.state.fields.email || ''} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)}
                                    />
                                </Col>
                                <Col>
                                    ...
                                    <Form.Control
                                        ...
                                        name='phone'
                                        value={this.state.fields.phone || ''} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)} />
                                </Col>
                            </Form.Row>
                            <Form.Row>
                                <Col>
                                    ...
                                    <Form.Control name='address'
                                        ...
                                        value={this.state.fields.address || ''} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)} />
                                </Col>
                            </Form.Row>
                            <Form.Row>
                                <Col>
                                    ...
                                    <Form.Control name='charityname'
                                        ...
                                        value={this.state.fields.charityname || ''} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)} />
                                </Col>
                                <Col>
                                    ...
                                    <Form.Control name='regnumber'
                                        ...
                                        value={this.state.fields.regnumber || ''} // Ensure empty string if null
                                        onChange={(event) => this.handleChange(event)} />
                                </Col>
                            </Form.Row>
                            <Form.Row>
                                <Col sm='12'>
                                    <Form.Group controlId='exampleForm.ControlTextarea1'>
                                        ...
                                        <Form.Control as='textarea' rows='3'
                                            name='description'
                                            value={this.state.fields.description || ''} // Ensure empty string if null
                                            onChange={(event) => this.handleChange(event)} />
                                    </Form.Group>
                                </Col>
                            </Form.Row>

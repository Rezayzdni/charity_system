...
class MyNavbar extends React.Component {
    ...
    componentDidMount() {
        let b = window.localStorage.getItem('is_benefactor')
        console.log('benefactor value in navbar:',  b)
        let ch = window.localStorage.getItem('is_charity')
        console.log('charity value in navbar:', ch)
        if (b === 'true') {
            this.setState({isBenefactor: true})
            console.log('benefactor true')
        }
        if (ch === 'true') {
            this.setState({isCharity: true})
            console.log('charity true')
        }
    }
